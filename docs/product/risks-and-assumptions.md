...
|---|---|---|---|---|
| R1 | **Supabase free project pauses after ~7 days idle**, breaking a "production" personal app. | High | Keep-warm GitHub Action shipped (Sprint 07, `keep-warm.yml`); secrets armed 2026-07-06 ([production-state](../operations/production-state.md)). Known gap: it fails open — fail-loud + issue alerting scheduled ([improvement plan](../roadmap/improvement-plan.md) S08.8). Neon is a fallback backend. | Mitigated — hardening in S08. |
